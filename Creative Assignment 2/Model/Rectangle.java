    ...
    public void setPos(int index, int x, int y){
     ...
     public void render(Graphics2D g2){
        ...
        if(p[0] == null && p[1] == null && p[2] == null && p[3] == null){
            return;
        } else if(p[1] == null && p[2] == null && p[3] == null){
            g2.fillOval(p[0].x, p[0].y, 5, 5);
        } else if(p[2] == null && p[3] == null){
            ...
            g2.drawLine(p[0].x, p[0].y, p[1].x, p[1].y);
            g2.drawLine(p[1].x, p[1].y, p[2].x, p[2].y);
            g2.drawLine(p[2].x, p[2].y, p[3].x, p[3].y);
            g2.drawLine(p[0].x, p[0].y,p[3].x,p[3].y);
        }
    }
}
